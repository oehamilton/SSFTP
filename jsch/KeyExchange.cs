...
namespace SSFTP.SharpSsh.jsch
{
	...
	*/
	...
	public abstract class KeyExchange
	{
		...
		public SSFTP.SharpSsh.java.String[] _guess=null;
		...
		*/
		...
		internal static SSFTP.SharpSsh.java.String[] guess(byte[]I_S, byte[]I_C)
		{
            //System.out.println("guess: ");
            SSFTP.SharpSsh.java.String[] guess=new SSFTP.SharpSsh.java.String[PROPOSAL_MAX];
