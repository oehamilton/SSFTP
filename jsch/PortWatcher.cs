...
using InetAddress = SSFTP.SharpSsh.java.net.InetAddress;
using String = SSFTP.SharpSsh.java.String;
...
namespace SSFTP.SharpSsh.jsch
{
	...
	*/
	...
	class PortWatcher : SSFTP.SharpSsh.java.lang.Runnable
	{
		private static SSFTP.SharpSsh.java.util.Vector pool=new SSFTP.SharpSsh.java.util.Vector();
