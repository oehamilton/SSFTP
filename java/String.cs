...
namespace SSFTP.SharpSsh.java
{
	...
	public class String
	{
		...
		public static SSFTP.SharpSsh.java.String operator+(SSFTP.SharpSsh.java.String s1, SSFTP.SharpSsh.java.String s2)
		{
			return new SSFTP.SharpSsh.java.String(s1.ToString()+s2.ToString());
		}
